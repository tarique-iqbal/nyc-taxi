...
echo ""
echo "Next steps:"
echo "  Terminal 1 (health):   python -m etl.entrypoints.health_server"
echo "  Terminal 2 (consumer): python -m etl.entrypoints.consumer  (also serves /metrics on PROMETHEUS_PORT_CONSUMER)"
echo "  Terminal 3 (producer): python -m etl.entrypoints.producer  (also serves /metrics on PROMETHEUS_PORT_PRODUCER)"
echo ""
