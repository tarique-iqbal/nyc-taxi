...
echo "  Terminal 2 (consumer): python -m etl.entrypoints.consumer -- also serves /metrics on 9101 (from .env)"
echo "  Terminal 3 (producer): python -m etl.entrypoints.producer -- also serves /metrics on 9100 (from .env)"
echo ""
